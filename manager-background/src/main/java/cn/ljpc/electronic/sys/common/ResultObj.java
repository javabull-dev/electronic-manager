...
public class ResultObj {
    ...
    public static final ResultObj BACKINPORT_SUCCESS = new ResultObj(Constast.OK,"出库成功");
    public static final ResultObj BACKINPORT_ERROR = new ResultObj(Constast.ERROR,"出库失败");
