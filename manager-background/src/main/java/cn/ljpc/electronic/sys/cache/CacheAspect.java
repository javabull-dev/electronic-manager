...
public class CacheAspect {
     ...
     * 声明部门的切面表达式
     */
    private static final String POINTCUT_DEPT_ADD = "execution(* cn.ljpc.electronic.sys.service.impl.DeptServiceImpl.save(..))";
    private static final String POINTCUT_DEPT_UPDATE = "execution(* cn.ljpc.electronic.sys.service.impl.DeptServiceImpl.updateById(..))";
    private static final String POINTCUT_DEPT_GET = "execution(* cn.ljpc.electronic.sys.service.impl.DeptServiceImpl.getById(..))";
    private static final String POINTCUT_DEPT_DELETE = "execution(* cn.ljpc.electronic.sys.service.impl.DeptServiceImpl.removeById(..))";
     ...
     * 声明用户的切面表达式
     */
    private static final String POINTCUT_USER_UPDATE = "execution(* cn.ljpc.electronic.sys.service.impl.UserServiceImpl.updateById(..))";
    private static final String POINTCUT_USER_ADD = "execution(* cn.ljpc.electronic.sys.service.impl.UserServiceImpl.updateById(..))";
    private static final String POINTCUT_USER_GET = "execution(* cn.ljpc.electronic.sys.service.impl.UserServiceImpl.getById(..))";
    private static final String POINTCUT_USER_DELETE = "execution(* cn.ljpc.electronic.sys.service.impl.UserServiceImpl.removeById(..))";
