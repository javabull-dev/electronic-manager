...
import cn.ljpc.electronic.sys.common.PinyinUtils;
import cn.ljpc.electronic.sys.common.ResultObj;
import cn.ljpc.electronic.sys.entity.Dept;
import cn.ljpc.electronic.sys.entity.Role;
import cn.ljpc.electronic.sys.entity.User;
import cn.ljpc.electronic.sys.service.IDeptService;
import cn.ljpc.electronic.sys.service.IRoleService;
import cn.ljpc.electronic.sys.service.IUserService;
import cn.ljpc.electronic.sys.vo.UserVo;
...
public class UserController {
    ...
    public DataGridView loadAllUser(UserVo userVo) {
        ...
        queryWrapper.eq(StringUtils.isNotBlank(userVo.getName()), "loginname",
                userVo.getName()).or().eq(StringUtils.isNotBlank(userVo.getName()),
                "name", userVo.getName());
    ...
    private void votoUser(UserVo userVo, User user) {
        user.setDeptname(userVo.getDeptname());
        user.setLeadername(userVo.getLeadername());
        user.setAddress(userVo.getAddress());
        user.setAvailable(userVo.getAvailable());
        user.setDeptid(userVo.getDeptid());
        user.setHiredate(userVo.getHiredate());
        user.setImgpath(userVo.getImgpath());
        user.setLoginname(userVo.getLoginname());
        user.setMgr(userVo.getMgr());
        user.setName(userVo.getName());
        user.setOrdernum(userVo.getOrdernum());
