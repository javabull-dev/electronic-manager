package cn.ljpc.electronic.bus.cache;


import cn.ljpc.electronic.bus.entity.Customer;
import cn.ljpc.electronic.sys.cache.CachePool;
...
public class BusinessCacheAspect {
     ...
     * 声明客户的切面表达式
     */
    private static final String POINTCUT_CUSTOMER_ADD = "execution(* cn.ljpc.electronic.bus.service.impl.CustomerServiceImpl.save(..))";
    private static final String POINTCUT_CUSTOMER_UPDATE = "execution(* cn.ljpc.electronic.bus.service.impl.CustomerServiceImpl.updateById(..))";
    private static final String POINTCUT_CUSTOMER_GET = "execution(* cn.ljpc.electronic.bus.service.impl.CustomerServiceImpl.getById(..))";
    private static final String POINTCUT_CUSTOMER_DELETE = "execution(* cn.ljpc.electronic.bus.service.impl.CustomerServiceImpl.removeById(..))";
    private static final String POINTCUT_CUSTOMER_BATCHDELETE = "execution(* cn.ljpc.electronic.bus.service.impl.CustomerServiceImpl.removeByIds(..))";
     ...
     * 声明商品的切面表达式
     */
    private static final String POINTCUT_GOODS_ADD = "execution(* cn.ljpc.electronic.bus.service.impl.GoodsServiceImpl.save(..))";
    private static final String POINTCUT_GOODS_UPDATE = "execution(* cn.ljpc.electronic.bus.service.impl.GoodsServiceImpl.updateById(..))";
    private static final String POINTCUT_GOODS_GET = "execution(* cn.ljpc.electronic.bus.service.impl.GoodsServiceImpl.getById(..))";
    private static final String POINTCUT_GOODS_DELETE = "execution(* cn.ljpc.electronic.bus.service.impl.GoodsServiceImpl.removeById(..))";
